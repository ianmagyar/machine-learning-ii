...
(assert (and (= vs13 0.0) (= vs22 0.0)
             ...
             (= p1 1.0) (= p6 0.6) (= p4 0.4) (= gamma 0.8)))

; calculating partial sums
(assert (= s11n (+ (* p4 (+ re (* gamma vs12))) (* p6 (+ re (* gamma vs11))))))
(assert (= s11e (+ (* p1 (+ re (* gamma vs12))))))
(assert (= s11s (+ (* p4 (+ re (* gamma vs12))) (* p6 (+ re (* gamma vs21))))))
(assert (= s11w (+ (* p1 (+ re (* gamma vs11))))))

(assert (= s12n (+ (* p6 (+ re (* gamma vs12))) (* p4 (+ rg (* gamma vs13))))))
(assert (= s12e (+ (* p1 (+ rg (* gamma vs13))))))
(assert (= s12s (+ (* p6 (+ rt (* gamma vs22))) (* p4 (+ rg (* gamma vs13))))))
(assert (= s12w (+ (* p6 (+ re (* gamma vs11))) (* p4 (+ re (* gamma vs12))))))

(assert (= s21n (+ (* p6 (+ re (* gamma vs11))) (* p4 (+ rt (* gamma vs22))))))
(assert (= s21e (+ (* p1 (+ rt (* gamma vs22))))))
(assert (= s21s (+ (* p6 (+ re (* gamma vs31))) (* p4 (+ rt (* gamma vs22))))))
